...
@SpringBootTest(classes = ConfigPropsApplication.class)
...
public class ConfigPropsApplicationTests {
	...
	public void whenListPropertyQueriedthenReturnsProperty() throws Exception {
		Assert.assertTrue("Couldn't bind list property!", properties.getDefaultRecipients()!=null);
	...
	public void whenMapPropertyQueriedthenReturnsProperty() throws Exception {
		...
		Assert.assertEquals("Incorrect value!", "value",properties.getAdditionalHeaders().get("p3"));
	}
